...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <form class="container" style="width:500px; margin-top: 50px;" method="post" action="/login-data">
    	{{ csrf_field() }}
	  <div class="form-group">
	    <label for="nameInput">NickName</label>
	    <input type="name" class="form-control" id="nameInput" name="user_name" placeholder="YourName">
	    <small id="NickNameHelper" class="form-text text-muted">We'll not Verify your name</small>
	  </div>
	  <div class="form-group">
